...
### Added
- **docs/ru/code_review_2024-09-15.md**, **docs/en/code_review_2024-09-15.md**: Добавлены отчёты по ревью с предложениями улучшений.
- **docs/ru/ideas.md**, **docs/en/ideas.md**: Заведены таблицы идей для централизованного учёта инициатив.
